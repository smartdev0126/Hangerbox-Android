...
public class Common {
    ...
    public static CharSequence[] categories_en = new CharSequence[0];

    public static CharSequence[] countries = new CharSequence[0];

    public static CharSequence[] countries_en = new CharSequence[0];

    public static String lang = "ja";

    public static Boolean addFavorite = false;
    public static Boolean initMyItem = false;
    public static Boolean initLibrary = false;
    ...
    public String loadJSONFromAsset(String fname) {
        String json = null;
        try {
            InputStream is = currentActivity.getAssets().open(fname);
    ...
    public static void setLocale() {
        if (me == null) {
            String langStr = Resources.getSystem().getConfiguration().locale.getLanguage();
            if (!langStr.equals("ja")) {
                lang = "en";
            }else {
                lang = "ja";
            }
        }else {
            if (me.getCountryName().equals(null) || me.getCountryName().equals("日本")) {
                lang = "ja";
            }else {
                lang = "en";
            }
